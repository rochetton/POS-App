...
Public Class FrmPrincipal
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            'Dim mensajeUsuario As String = mensajeUsuarioDESIS("<?xml version=""1.0"" encoding=""utf-8""?><soap:Envelope xmlns:soap=""http://www.w3.org/2003/05/soap-envelope"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema""><soap:Body><ConsultarEstadoResponse xmlns=""http://tempuri.org""><ConsultarEstadoResult>&lt;?xml version=""1.0""?&gt;&lt;WSPLANO&gt;&lt;Resultado&gt;False&lt;/Resultado&gt;&lt;Mensaje&gt;Posee documentos con error.&lt;/Mensaje&gt;&lt;Detalle&gt;&lt;Documento&gt;&lt;Folio&gt;47286&lt;/Folio&gt;&lt;TipoDte&gt;61&lt;/TipoDte&gt;&lt;Operacion&gt;VENTA&lt;/Operacion&gt;&lt;Fecha&gt;2025-04-01T14:42:55&lt;/Fecha&gt;&lt;Resultado&gt;False&lt;/Resultado&gt;&lt;Error&gt;ERROR: P0001: El documento Tipo 33 , folio 813514 ya fue anulado previamente&lt;/Error&gt;&lt;/Documento&gt;&lt;/Detalle&gt;&lt;/WSPLANO&gt;</ConsultarEstadoResult></ConsultarEstadoResponse></soap:Body></soap:Envelope>")

            If Global.caja2.My.MySettings.Default.AmbienteSAP = "0" Then
                Me.Text &= " - Ambiente Prueba" & " - Pantalla Full HD : " & Screen.PrimaryScreen.WorkingArea.Width.ToString() & " x " & Screen.PrimaryScreen.WorkingArea.Height.ToString()
            End If
            ...
            'Call recargarDocumentoPos(876539)
    ...
    Private Sub btnEfectivo_Click(sender As Object, e As EventArgs) Handles btnEfectivo.Click
        ...
        Panel_Efectivo.Location = New Point(29, 142)
    ...
    Private Sub btnTarjeta_Click(sender As Object, e As EventArgs) Handles btnTarjeta.Click
        ...
        Panel_Tarjeta.Visible = True
        Panel_Tarjeta.Location = New Point(29, 142)
    End Sub
    ...
    Private Sub btnLineaCredito_Click(sender As Object, e As EventArgs) Handles btnLineaCredito.Click
        ...
        Panel_CtaCAREN.Location = New Point(29, 142)
    End Sub
    ...
    Private Sub btnLineaFuncionario_Click(sender As Object, e As EventArgs) Handles btnLineaFuncionario.Click
        ...
        panel_LineaFuncionario.Location = New Point(29, 142)
    End Sub
    ...
    Private Sub btnCheque_Click(sender As Object, e As EventArgs) Handles btnCheque.Click
        ...
        Panel_Cheque.Location = New Point(18, 142)
    ...
    Private Sub btnTransferencia_Click(sender As Object, e As EventArgs) Handles btnTransferencia.Click
        ...
        Panel_Transferencia.Location = New Point(29, 138)
    End Sub
    ...
    Private Sub btnNotaCredito_Click(sender As Object, e As EventArgs) Handles btnNotaCredito.Click
        ...
        Panel_NotaCredito.Location = New Point(29, 142)
    End Sub
    ...
    Private Sub btnAnticipos_Click(sender As Object, e As EventArgs) Handles btnAnticipos.Click
        ...
        Panel_Anticipos.Location = New Point(29, 142)
    End Sub
    ...
    Private Sub btnMedioPago_EnabledChanged(sender As Object, e As EventArgs) Handles btnEfectivo.EnabledChanged, btnLineaCredito.EnabledChanged
