Namespace APIDESIS
    ...
    Partial Public Class EnvelopeProcesarWSMasivo

        Private headerField As Object

        Private bodyField As EnvelopeBodyProcesarWSMasivo

        Public Sub New()
            Me.Body = New APIDESIS.EnvelopeBodyProcesarWSMasivo()
            Me.Body.Procesar = New APIDESIS.ProcesarWSMasivo()
        ...
        '''<remarks/>
        Public Property Body() As EnvelopeBodyProcesarWSMasivo
            Get
                Return Me.bodyField
            End Get
            Set
    ...
    Partial Public Class EnvelopeBodyProcesarWSMasivo

        Private procesarField As ProcesarWSMasivo

        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute([ElementName]:="ProcesarWSMasivo", [Namespace]:="http://tempuri.org")>
        Public Property Procesar() As ProcesarWSMasivo
            Get
    ...
    System.Xml.Serialization.XmlRootAttribute("ProcesarWSMasivo", [Namespace]:="http://tempuri.org", IsNullable:=False)>
    Partial Public Class ProcesarWSMasivo
